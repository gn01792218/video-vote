...
import useVideoAPI from '~/composables/api/useVideoAPI';
import type { Video } from '~/types/video';
const videoElement = ref<HTMLVideoElement | null>(null)
const currentVideo = ref<Video| null>(null)
// const { currentVideoUrl, currentVideoIndex } = storeToRefs(useVideoStore())
// const { setVideoList } = useVideoStore()
const { getCurrentVideo, getVideos } = useVideoAPI()
